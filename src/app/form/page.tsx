      ...
      <div className="relative flex flex-col  justify-center w-full text-center bg-[url(/bg.png)] bg-center bg-cover pt-[145px] -mt-[50px]">
        ...
        <div className="relative z-10">
          <div className="mb-[16px]">
            <h2 className="uppercase font-bold text-[32px] mb-[40px] text-white leading-[30px]">
              Get personalized support based on <br></br> your unique financial
              situation.
            </h2>
          </div>
          {/* Input Fields */}
          <div className="flex flex-col items-center my-[24px] max-w-[500px] mx-auto gap-y-[24px]">
            <input
              className="w-full bg-transparent placeholder:text-white  text-white text-[12px] border border-slate-200 px-3 py-4 transition duration-300 ease focus:outline-none"
          ...
          <div className="w-[600px] mt-[32px] flex justify-center mx-auto">
